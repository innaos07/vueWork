...
export const useTasksStore = defineStore("tasks", {
  ...
  //     const searchFilter = task => task.title.toLowerCase().includes(filtersStore.filters.search.toLoverCase().trim());
  //     const usersFilter = task => filtersStore.filters.users.some(userId => userId === task.userId);
  //     const statusesFilter = task => filtersStore.filters.statuses.some(el => el === task.status || el === task.timeStatus);
